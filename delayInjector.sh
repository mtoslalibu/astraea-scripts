...
## run workload 
./hey_linux_amd64 -z 30s -c 6 -q 6 -m POST -H "Content-Type: application/json" -d '{"startingPlace": "Shang Hai", "endPlace": "Su Zhou"}' http://localhost:8080/api/v1/travelservice/trips/left > /tmp/heyyinjected &
workloadPID=$!
